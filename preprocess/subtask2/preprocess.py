...
if __name__ == '__main__':
    ...
    parser.add_argument('--raw_dir', default='data/raw/subtask2', help='原始数据目录')
    parser.add_argument('--out_dir', default='data/processed/subtask2', help='处理后数据目录')
    parser.add_argument('--top_k', type=int, default=6, help='BM25检索的法条数量')
